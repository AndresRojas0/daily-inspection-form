...
export default function DailyInspectionApp() {
  const [form, setForm] = useState<DailyInspectionForm>({
    ...
    serviceChecks: [
      {
        id: "1",
        lineOrRouteNumber: "Route 1",
        driverName: "John Doe",
        serviceCode: "SVC001",
        fleetCoachNumber: "FC-101",
        exactHourOfArrival: "08:00",
        gpsStatus: { minutes: 0, status: "on-time" },
        passengersOnBoard: 10,
        passesUsed: 5,
        addressOfStop: "123 Main St",
        observations: "No issues.",
        nonCompliance: false,
      },
      {
        id: "2",
        lineOrRouteNumber: "Route 2",
        driverName: "Jane Smith",
        serviceCode: "SVC002",
        fleetCoachNumber: "FC-102",
        exactHourOfArrival: "09:30",
        gpsStatus: { minutes: -5, status: "late" },
        passengersOnBoard: 15,
        passesUsed: 8,
        addressOfStop: "456 Oak Ave",
        observations: "Minor delay due to traffic. INFORME",
        nonCompliance: true,
      },
    ],
  })
